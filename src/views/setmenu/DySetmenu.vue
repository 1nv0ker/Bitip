<template>
    <div class="w-full animate__slideInLeft animate__animated" >
        ...
        <div class="flex gap-x-[1rem] justify-center">
            <div v-for="card in cards.slice(0,4)" :class="`p-[2rem] w-[19rem] h-[22.125rem] baisc_card rounded-[1.5rem] ${selected==card.key?'hover_card':'card'}`"
            ...
            @mouseenter="selected=card.key">
                ...
                <div class="w-full pt-[2rem]">
                    ...
                    <div class="w-full flex justify-between">
                        ...
                        <span class="text-[#702B12] text-[1.125rem] font-semibold originPrice_value">{{ card.originPrice }}</span>
                    </div>
                </div>
        ...
        <div class="flex gap-x-[1rem] justify-center mt-[1.5rem]">
            <div v-for="card in cards.slice(4,6)" :class="`p-[2rem] baisc_card w-[19rem] h-[22.125rem] rounded-[1.5rem] ${selected==card.key?'hover_card':'card'}`"
            @mouseleave="selected=0"
            @mouseenter="selected=card.key">
                <div class="w-full flex flex-col">
                    <span class="text-[#191919] text-[1.5rem] font-bold title">{{card.title}}</span>
