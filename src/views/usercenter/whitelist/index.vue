<template>
    <div class="w-full bg-[white] p-[1.75rem] rounded-[1.5rem]">
        ...
        <div class="w-full mt-[1.5rem] h-[41rem]">
            <a-table :columns="columns" :data-source="tableDatas"  :pagination="false" :row-selection="rowSelection" rowKey="id" :loading="params.loading" class="h-[38rem]">
