<template>
    <div class="w-full flex flex-col gap-[1.75rem]">
        <div class="w-full rounded-[1.5rem] bg-white p-[1.75rem]">
            ...
            <div class="mt-[1.5rem] h-[15rem]">
                <a-table :columns="columns" :data-source="tableDatas"  :pagination="false" :loading="loading" class="max-h-[12rem]">
        ...
        <div class="w-full h-[32.5rem] p-[1.75rem] rounded-[1.5rem] bg-[white]">
            ...
            <div class="w-full h-[26rem]" ref="mainRef">
