export const en = {
    ...
    service: {
        ...
        title2_content1: 'Using high-quality agents can improve the extraction of effective data and analyze information to support your business decisions.',
        title2_subtitle2: 'Dealer Community',
        title2_content2: 'Increase your product activity on the Internet and sell more',
        title2_subtitle3: 'Market Research',
        title2_content3: 'Be fully prepared for market expansion',
        ...
        title3_card1_title: 'Business Ethics',
        ...
        title3_card2_title: 'Legal agent pool',
        title3_card2_subtitle:'The residential proxy pool comes from carefully selected and ethical partners.',
        title3_card3_title: 'Supplier Audit Process',
        title3_card3_subtitle:'The entire supply chain goes through a rigorous and comprehensive review process to avoid any potential supplier failures.',
...
export const zh = {
    ...
    dyagent: {
        ...
        titl2_item2: '正规来源',
        title2_subtitle2:'我们只提供和测试世界上最快的真实住宅代理，100% 匿名性和100% IP 可用性。',
        titl2_item3: '流量永不过期',
