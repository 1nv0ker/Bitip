export const en = {
    ...
    first: {
        ...
        // cardContent2: 'Relying on industry-leading proxy resources to achieve automatic collection of global web page data',
    ...
    third: {
        ...
        item2Subtitle:'Billion-level proxy resource pool',
    ...
    service: {
        ...
        title3_title4_content:'We will continue to optimize our proxy services based on business development to ensure that your needs are always met.',
        title4:'The common choice of many companies'
    },
    setmenu: {
        title: 'BitIP proxy Discount Package Type',
        ...
        question1:'What is the difference between product packages and using proxies for credit recharge?',
        answer1: '',
        question2:'What is the difference between product packages and using proxies for credit recharge?',
        answer2: '',
        question3:'What is the difference between product packages and using proxies for credit recharge?',
        answer3: '',
        question4:'What is the difference between product packages and using proxies for credit recharge?',
        answer4: '',
        question5:'What is the difference between product packages and using proxies for credit recharge?',
        answer5: '',
        question6:'What is the difference between product packages and using proxies for credit recharge?',
        answer6: '',
    ...
    backend_menu: {
        ...
        menu2_sub1: 'Purchase proxy',
        menu2_sub2:'Purchased proxy',
    ...
    dyagent: {
        title1:'Dynamic Residential proxy',
        ...
        title2:'Why choose BitIP Residential proxy',
    ...
    staticagent: {
        ...
        title2_subtitle2:'Our proxies are private or dedicated, which means that when you purchase a residential proxy you will be the sole user of that IP.。',
        ...
        question1:'How to bill static residential proxies?',
        answer1_1:'Static residential proxies are charged according to the number of IPs. You can choose to purchase a single IP. If you have a large demand, you can recharge your balance and purchase it more preferentially.',
        ...
        question6:'Are static residential proxies shared or exclusive?',
